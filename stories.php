...
<div class="row banners">
  ...
  <div class="intro col-10">
    <h1>We share stories about people, places, and cultures
...
<div class="row col-12 story articles">
  ...
  <div class="row col-12 story prints">
    ...
    <div class="mission mission col-md-4 col-xs-10">
  ...
  <div class="scroll">
    ...
    <div class="mag col-4">
      ...
      <div class="issues">
        ...
        <a href="#" class="read-online">Read Online → </a>
      </div>
    </div>
    <div class="col-1">
    </div>
    ...
    <div class="mag col-4">
      <img class="covers" src="public/images/pr_volume.png"/>
      <div class="issues">
    ...
    <div class="mag col-4">
      <img class="covers" src="public/images/volume1.png"/>
      <div class="issues">
