...
<body>
  ...
  <div class="row characters">
    ...
    <div class="col-9">
      <img id="characters" src="public/images/characters.png"/>
    </div>
    <div class="col-2">
    </div>
  </div>
  ...
  <div class="row banners">
    ...
    <div class="intro col-10"><h1>Founded in Aug 2017, Guac is an award-winning
      travel publication run by an interdisciplinary group of students at
      Cornell University.</h1>
    </div>
    <div class="col-1">
    </div>
  </div>
  ...
  <div class="row milestones journey">
    <div class="col-1">
    </div>
    <div class="col-9">
  ...
  <div class="row milestones justify-content-center first">
    <div class="col-sm-1 col-xs-1">
    </div>
    <div class="col-sm-4 col-xs-10 img">
      <img class="left-img" src="public/images/journey1.png">
    </div>
    <div class="col-sm-6 col-xs-9 right-paragraphs">
      <h4 class="time">Aug 2017</h4>
      <h2>"Let's start a travel magazine"</h2>
  ...
  <div class="row milestones justify-content-center">
    <div class="col-sm-1 col-xs-1">
    </div>
    <div class="col-sm-4 col-xs-10 img">
      <img class="left-img" src="public/images/journey2.png"></img>
    </div>
    <div class="col-sm-6 col-xs-9 right-paragraphs">
      <h4 class="time">Nov 2017</h4>
      <h2>Hidden Gems, Our First Issue</h2>
  ...
  <div class="row milestones justify-content-center">
    ...
    <div class="col-sm-6 col-xs-9 right-paragraphs">
      ...
      <h2>40 Students, 14 Countries</h2>
  ...
  <div class="row milestones justify-content-center">
    ...
    <div class="col-sm-6 col-xs-9 right-paragraphs">
        ...
        <h2>Perkins Prize</h2>
        <p class="center-details">Only after 8 months, Guac Magazine was awarded an honorary
  ...
  <div class="row milestones justify-content-center last">
    <div class="col-sm-1 col-xs-1">
    </div>
    <div class="col-sm-4 col-xs-10 img">
      <img class="center-img" src="public/images/journey5.png"></img>
    </div>
    <div class="col-sm-6 col-xs-9 right-paragraphs">
      <h4 class="time">Now</h4>
      <h2>More than a magazine</h2>
  ...
  <div class="row col-12 team justify-content-center">
    ...
    <div class="mission col-sm-4 col-xs-10">
