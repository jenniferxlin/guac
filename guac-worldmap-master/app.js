	...
	$.getJSON('/stories/json?country='+country, function(result) {
        $.each(result, function(i, field) {
            ...
            var country = field.country.name,
            	...
            	title = field.title,
            	href = "guide1.html"
            $("#content-holder").append("<div class='col-md-4'>")
            .append("<div class='featured-article featured-3'><a href="+href+"><img src="+image+"> <p class='issue'>"+issue+"</p><h3>"+title+"</h3></a></div>")
            .append("</div>");
        });
    });
